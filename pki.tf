...
locals {
  ...
  intermediate_cn = "Accelerated GCP Lab Intermediate CA 2025"
}
...
resource "vault_pki_secret_backend_issuer" "intermediate" {
  backend     = vault_mount.pki.path
  issuer_ref  = "1fb436da-3ae6-f5bf-1ff7-0b933f27a494" # vault_pki_secret_backend_intermediate_set_signed.intermediate.imported_issuers[0]
  issuer_name = "intermediate"
}

resource "vault_pki_secret_backend_config_issuers" "intermediate" {
  backend                       = vault_mount.pki.path
  default                       = "1fb436da-3ae6-f5bf-1ff7-0b933f27a494" # vault_pki_secret_backend_issuer.intermediate.issuer_id
